---
title: Monorepo Workspace Management
description: pnpm workspaces and TurboRepo configuration and workflows
---

# Monorepo Workspace Management

The Maya AdonisJS project uses pnpm workspaces with TurboRepo for efficient monorepo management, enabling scalable development across multiple applications and shared packages.
